                ...
                <ul uk-accordion="multiple:true">
                    <li v-for="(slide, id) in widget.data.slideshow" :key="id">
                        ...
                        <div class="uk-accordion-content">
                            ...
                            <div class="uk-margin">
                                <label class="uk-form-label">{{ "Hand writing" | trans }}</label>
                                <div class="uk-form-controls">
                                    <input type="text" class="uk-input" v-model="slide.handwriting"/>
                                </div>
                            </div>
                            ...
                            <div class="uk-margin">
                                <label class="uk-form-label">{{ "Video" | trans }}</label>
                                <div class="uk-form-controls">
                                    <input-video :source.sync="slide.video" v-model="slide.video"></input-video>
                                    <input type="text" :placeholder="'Youtube Video Link' | trans" class="uk-input uk-margin-small-top" v-model="slide.video" />
                                </div>
                            </div>
                        </div>
                    </li>
...
window.Widgets.components["leylada-hero.settings"] = HeroWidget;
</script>